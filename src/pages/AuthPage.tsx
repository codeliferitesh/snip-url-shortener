...
import { Zap, Mail, Lock, User, Eye, EyeOff, Chrome } from 'lucide-react';
...
export default function AuthPage({ mode }: Props) {
  const { signInWithGoogle, signInWithEmail, registerWithEmail, loading } = useAuthStore();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-16 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(14,165,233,0.12),transparent)] pointer-events-none" />
      ...
      <motion.div
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-display font-bold text-2xl gradient-text">Snip</span>
        </Link>
        ...
        <div className="card p-8">
          ...
          {/* Google sign-in */}
          <button onClick={handleGoogle} disabled={loading || submitting} className="btn-ghost w-full mb-6 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Full name" required className="input-base pl-11" autoFocus
                />
              </div>
            )}
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Email address" required className="input-base pl-11"
                autoFocus={isLogin}
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Password" required className="input-base pl-11 pr-11"
              />
            ...
            <button type="submit" disabled={submitting || loading} className="btn-primary w-full py-3">
              {submitting ? <LoadingSpinner size="sm" /> : (isLogin ? 'Sign In' : 'Create Account')}
            </button>
          </form>

          <p className="text-sm text-center mt-6" style={{ color: 'var(--text-muted)' }}>
            {isLogin ? "Don't have an account? " : 'Already have an account? '}
            <Link to={isLogin ? '/register' : '/login'} className="text-brand-500 hover:underline font-medium">
